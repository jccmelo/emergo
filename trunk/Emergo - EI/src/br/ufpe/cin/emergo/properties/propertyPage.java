...
IWorkbenchPropertyPage {
          ...
          protected Control createContents(Composite parent) {
                       ...
                       System.out.println("procedural key"+SystemProperties.INTERPROCEDURAL_PROPKEY);
          ...
          public boolean performOk() {
                       //setInterprocedural(textField2.getText());
        	  	System.out.println(radioInterprocedural.getSelection());
